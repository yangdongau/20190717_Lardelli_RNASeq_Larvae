...
Use `goseq` to perform pathway enrichment analysis and print out the top five significantly-changed pathways
...
ireGR <- list.files(path = here::here("analysis"),pattern = "gff.gz") %>%
